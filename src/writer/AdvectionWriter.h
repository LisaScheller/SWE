...
#ifndef SWE1D_ADVECTIONWRITER_H
#define SWE1D_ADVECTIONWRITER_H
#include "../types.h"
 ...
 */
    ...
    public:
        // constructor
        AdvectionWriter( const std::string& basename = "swe1d", const T cellSize = 1)
                : m_basename(basename),
                  m_cellSize(cellSize),
                  m_timeStep(0)
        {
